...
{
    setlocale(LC_ALL, "ru");
    const wchar_t lpszAppName[] = L"notepad.exe";
    wchar_t mutablelpszAppName[MAX_PATH];
    wcscpy_s(mutablelpszAppName, lpszAppName);
    STARTUPINFO si;
    ...
    {
        cout << "There mew process is not created" << endl
